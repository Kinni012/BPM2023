...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic.Classification {
  [Plugin("HeuristicLab.Problems.DataAnalysis.Symbolic.Classification","Provides classes to perform symbolic classification (single- or multiobjective).", "3.4.12.17450")]
